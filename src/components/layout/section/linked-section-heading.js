...
export const LinkedSectionHeading = ({ to = '/', children }) =>
  <div className="mt-[1em] text-heading-1 mb-[max(4rem,0.5em)] flex justify-between items-center gap-4">
    ...
    <Magnetic multiplier={ 35 }>
      {
        position =>
          <MotionLink
            ...
            <m.div style={ position } className="h-full w-full transition-colors duration-300 fill-secondary/50 group-hover:fill-secondary">
              <ArrowOutward/>
            </m.div>
          </MotionLink>
      }
