...
export const SectionTitle = ({ align = 'left', hyphens = 'off', children }) => {
  ...
  return (
    <m.p className={ `mb-14 max-w-sm text-2xl sm:mb-16 md:mb-20 md:max-w-lg lg:max-w-2xl 2xl:max-w-4xl
