...
export const Checkbox = ({ id, children }) => {
  return (
    <m.div className="grow" layout>
      ...
      <label className="block py-4 px-[min(3rem,var(--horizontal-spacing))] text-secondary/40 dark:text-secondary/20 border-r border-b border-secondary/20 transition-colors duration-300
